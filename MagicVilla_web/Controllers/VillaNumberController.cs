...
namespace MagicVilla_web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> CreateNumberVilla(VillaNumberCreateVM model)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    {
                        ModelState.AddModelError("ErrorMessages", string.Join(", ", response.ErrorMessages) /*response.ErrorMessages.FirstOrDefault()*/);
                    }
                }
        ...
        [Authorize(Roles = "admin")]
        [HttpGet]
        public async Task<IActionResult> DeleteteVillaNumber(int villaNo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteteVillaNumber(VillaNumberDeleteVM model)
        {

            var repsonse = await _villaNumberService.DeleteAsync<APIResponse>(model.VillaNumber.VillaNo, HttpContext.Session.GetString(SD.SessionToken));
